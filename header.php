...
<title><?php print $title; ?> | SkyMap</title>
...
<link rel="shortcut icon" type="image/x-icon" href="<?php print $globalURL; ?>/images/favicon-32x32.png">
<link rel="apple-touch-icon" href="<?php print $globalURL; ?>/images/favicon-32x32.png">
<!--[if lt IE 9]>
...
<div class="navbar navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php if ($globalURL == '') print '/'; else print $globalURL; ?>">
      	<img src="<?php print $globalURL.$logoURL; ?>" height="60px" style="display: block;position: relative;top: -14px;" />
      </a>
    </div>
